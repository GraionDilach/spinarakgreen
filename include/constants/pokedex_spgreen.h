...
enum {
    ...
    NATIONAL_DEX_HEARTEY,
    NATIONAL_DEX_TANGELICA,
    ...
    NATIONAL_DEX_PINPLUX,
    NATIONAL_DEX_TAUROS,
    NATIONAL_DEX_TAUROS_PALDEAN_COMBAT,
    NATIONAL_DEX_TAUROS_PALDEAN_BLAZE,
    NATIONAL_DEX_TAUROS_PALDEAN_AQUA,
    ...
    NATIONAL_DEX_WATCHOWL,
    NATIONAL_DEX_NOCTOWL,
    NATIONAL_DEX_LEDYSTAR,
    NATIONAL_DEX_LEDYBA,
    NATIONAL_DEX_LEDIAN,
    ...
    NATIONAL_DEX_CELEBI,
    // full beta lines
    NATIONAL_DEX_FLABEAR,
    NATIONAL_DEX_VOLBEAR,
    NATIONAL_DEX_DYNABEAR,
    NATIONAL_DEX_CRUISEAL,
    NATIONAL_DEX_MARICE,
    NATIONAL_DEX_LAKENESS,
    NATIONAL_DEX_KOTORA,
    NATIONAL_DEX_RAITORA,
    NATIONAL_DEX_VOONAIL,
    NATIONAL_DEX_KYONPAN,
    NATIONAL_DEX_LIONBOMB,
    NATIONAL_DEX_RINRING,
    NATIONAL_DEX_BELLRUN,
    NATIONAL_DEX_RIBBIRABB,
    NATIONAL_DEX_WOLFMAN,
    NATIONAL_DEX_WARWOLF,
    NATIONAL_DEX_KAZUFROG,
    NATIONAL_DEX_TOADRYU,
    NATIONAL_DEX_SICKLEASEL,
    NATIONAL_DEX_LIMANBO,
    NATIONAL_DEX_BIMANBO,
    NATIONAL_DEX_NOKOCHI,
    NATIONAL_DEX_ANKOCHI,
    NATIONAL_DEX_MODELION,
    NATIONAL_DEX_SHADRAKE,
    NATIONAL_DEX_JAGG,
    NATIONAL_DEX_IKARI,
    NATIONAL_DEX_HANAMOGURA,
    NATIONAL_DEX_LEVIRAY,
    NATIONAL_DEX_TUSKRUSH,
    NATIONAL_DEX_BUU,
    NATIONAL_DEX_CACTORMUS,
    NATIONAL_DEX_BLOTTLE,
    NATIONAL_DEX_PENDRAKEN,
    // NATIONAL_DEX_CHEEP,
    // NATIONAL_DEX_JABETTA,
    NATIONAL_DEX_RAMOOSE,
    NATIONAL_DEX_GORILLAIMO,
    NATIONAL_DEX_FLAMEPAW,
    NATIONAL_DEX_RUFFMIST,
    NATIONAL_DEX_SPARKMANE,
    NATIONAL_DEX_PETALOUND,
    // similar to Gen1/Gen2 scrapped designs (or Meltan)
...
enum {
    ...
    HOENN_DEX_VENUSAUR_GIGANTAMAX,
    HOENN_DEX_CHARMANDER,
    HOENN_DEX_CHARMELEON,
    HOENN_DEX_CHARIZARD,
    HOENN_DEX_CHARIZARD_MEGA_X,
    HOENN_DEX_CHARIZARD_GIGANTAMAX,
    HOENN_DEX_SQUIRTLE,
    HOENN_DEX_WARTORTLE,
    HOENN_DEX_BLASTOISE,
    HOENN_DEX_BLASTOISE_MEGA,
    HOENN_DEX_BLASTOISE_GIGANTAMAX,
    HOENN_DEX_CATERPIE,
    HOENN_DEX_METAPOD,
    HOENN_DEX_BUTTERFREE,
    HOENN_DEX_BUTTERFREE_GIGANTAMAX,
    HOENN_DEX_WEEDLE,
    HOENN_DEX_KAKUNA,
    HOENN_DEX_BEEDRILL,
    ...
    HOENN_DEX_MACHOKE,
    HOENN_DEX_MACHAMP,
    HOENN_DEX_MACHAMP_GIGANTAMAX,
    HOENN_DEX_BELLSPROUT,
    HOENN_DEX_WEEPINBELL,
    HOENN_DEX_VICTREEBEL,
    HOENN_DEX_PITCHTREEBEL,
    HOENN_DEX_TENTACOOL,
    ...
    HOENN_DEX_PINPLUX,
    HOENN_DEX_TAUROS,
    HOENN_DEX_TAUROS_PALDEAN_COMBAT,
    HOENN_DEX_TAUROS_PALDEAN_BLAZE,
    HOENN_DEX_TAUROS_PALDEAN_AQUA,
    HOENN_DEX_MAGIKARP,
    HOENN_DEX_GYARADOS,
    HOENN_DEX_GYARADOS_MEGA,
    HOENN_DEX_LAPRAS,
    HOENN_DEX_LAPRAS_GIGANTAMAX,
    HOENN_DEX_DITTO,
    HOENN_DEX_EEVEE,
    HOENN_DEX_VAPOREON,
    HOENN_DEX_JOLTEON,
    ...
    HOENN_DEX_DOTTLER,
    HOENN_DEX_ORBEETLE,
    HOENN_DEX_ORBEETLE_GIGANTAMAX,
    HOENN_DEX_MAREANIE,
    HOENN_DEX_TOXAPEX,
    HOENN_DEX_FLABEBE,
    HOENN_DEX_FLOETTE,
    HOENN_DEX_FLORGES,
    HOENN_DEX_FLOETTE_ETERNAL,
    HOENN_DEX_SKITTY,
    HOENN_DEX_DELCATTY,
    HOENN_DEX_MELTAN,
    HOENN_DEX_MELMETAL,
    HOENN_DEX_MELMETAL_GIGANTAMAX,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
    HOENN_DEX_SCEPTILE,
    ...
    HOENN_DEX_CORVIKNIGHT_GIGANTAMAX,
    HOENN_DEX_WATTREL,
    ...
    HOENN_DEX_HATTREM,
    HOENN_DEX_HATTERENE,
    HOENN_DEX_HATTERENE_GIGANTAMAX,
    HOENN_DEX_GOTHITA,
    HOENN_DEX_GOTHORITA,
