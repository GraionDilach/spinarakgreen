...
//SpinarakGreen moves
#define MOVE_PSYRIPPLE (MOVES_COUNT_GEN9 + 0)
#define MOVE_COMET_CRASH (MOVES_COUNT_GEN9 + 1)
#define MOVE_TERA_BLAST_SPGREEN (MOVES_COUNT_GEN9 + 2)
#define MOVE_TERA_BALL (MOVES_COUNT_GEN9 + 3)
#define MOVE_SLICE (MOVES_COUNT_GEN9 + 4)
#define MOVE_LEAF_SLICE (MOVES_COUNT_GEN9 + 5)

#define MOVES_COUNT_SPGREEN (MOVES_COUNT_GEN9 + 6)

#define MOVES_COUNT         MOVES_COUNT_SPGREEN
