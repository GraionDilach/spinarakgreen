...
#define VAR_BATTLE_BGM                                   0x40F9 // storage for externally set battle music (could be TEMP_F?)
...
#define VAR_0x8014                    0x8014 // was unused in base game, will store party starting level during battles
