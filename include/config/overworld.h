...
#define OW_MON_BOBBING                 FALSE      // If true, follower pokemon will bob up and down during their idle & walking animations
#define LARGE_OW_SUPPORT               FALSE      // If true, adds a small amount of overhead to OW code so that large (48x48, 64x64) OWs will display correctly under bridges, etc.
...
#define OW_MON_POKEBALLS               FALSE      // Followers will emerge from the pokeball they are stored in, instead of a normal pokeball
