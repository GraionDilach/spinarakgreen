...
#define B_HIDDEN_POWER_DMG          GEN_SPGRN  // In Gen6+, Hidden Power's base power was set to always be 60. Before, it was determined by the mon's IVs.
...
#define B_UPDATED_TYPE_MATCHUPS     GEN_SPGRN  // Updates Type matchups. src/data/types_info.h for details.
...
#define B_FLAG_NO_BAG_USE           FLAG_FLAG_NO_BAG_USE       // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          FLAG_FLAG_NO_CATCHING      // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           FLAG_FLAG_NO_RUNNING       // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
