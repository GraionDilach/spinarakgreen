...
#define B_SPGREEN_TYPE_MATCHUP      GEN_SPGRN  // Spinarak Green uses it's own type matchup chart.
...
#define B_TRAINER_CLASS_POKE_BALLS      GEN_SPGRN  // In Gen7+, trainers will use certain types of Poké Balls depending on their trainer class.
