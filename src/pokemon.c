...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(PITCHTREEBEL),
    ...
    HOENN_TO_NATIONAL(HEARTEY),
    HOENN_TO_NATIONAL(TANGELICA),
    ...
    HOENN_TO_NATIONAL(PINPLUX),
    HOENN_TO_NATIONAL(TAUROS),
    HOENN_TO_NATIONAL(TAUROS_PALDEAN_COMBAT),
    HOENN_TO_NATIONAL(TAUROS_PALDEAN_BLAZE),
    HOENN_TO_NATIONAL(TAUROS_PALDEAN_AQUA),
    ...
    HOENN_TO_NATIONAL(WATCHOWL),
    HOENN_TO_NATIONAL(NOCTOWL),
    HOENN_TO_NATIONAL(LEDYSTAR),
    ...
    HOENN_TO_NATIONAL(FLABEAR),
    HOENN_TO_NATIONAL(VOLBEAR),
    HOENN_TO_NATIONAL(DYNABEAR),
    HOENN_TO_NATIONAL(CRUISEAL),
    HOENN_TO_NATIONAL(MARICE),
    HOENN_TO_NATIONAL(LAKENESS),
    HOENN_TO_NATIONAL(KOTORA),
    HOENN_TO_NATIONAL(RAITORA),
    HOENN_TO_NATIONAL(VOONAIL),
    HOENN_TO_NATIONAL(KYONPAN),
    HOENN_TO_NATIONAL(LIONBOMB),
    HOENN_TO_NATIONAL(RINRING),
    HOENN_TO_NATIONAL(BELLRUN),
    HOENN_TO_NATIONAL(RIBBIRABB),
    HOENN_TO_NATIONAL(WOLFMAN),
    HOENN_TO_NATIONAL(WARWOLF),
    HOENN_TO_NATIONAL(KAZUFROG),
    HOENN_TO_NATIONAL(TOADRYU),
    HOENN_TO_NATIONAL(SICKLEASEL),
    HOENN_TO_NATIONAL(LIMANBO),
    HOENN_TO_NATIONAL(BIMANBO),
    HOENN_TO_NATIONAL(NOKOCHI),
    HOENN_TO_NATIONAL(ANKOCHI),
    HOENN_TO_NATIONAL(MODELION),
    HOENN_TO_NATIONAL(SHADRAKE),
    HOENN_TO_NATIONAL(JAGG),
    HOENN_TO_NATIONAL(IKARI),
    HOENN_TO_NATIONAL(HANAMOGURA),
    HOENN_TO_NATIONAL(LEVIRAY),
    HOENN_TO_NATIONAL(TUSKRUSH),
    HOENN_TO_NATIONAL(BUU),
    HOENN_TO_NATIONAL(CACTORMUS),
    HOENN_TO_NATIONAL(BLOTTLE),
    HOENN_TO_NATIONAL(PENDRAKEN),
    // HOENN_TO_NATIONAL(CHEEP),
    // HOENN_TO_NATIONAL(JABETTA),
    HOENN_TO_NATIONAL(RAMOOSE),
    HOENN_TO_NATIONAL(GORILLAIMO),
    HOENN_TO_NATIONAL(FLAMEPAW),
    HOENN_TO_NATIONAL(RUFFMIST),
    HOENN_TO_NATIONAL(SPARKMANE),
    HOENN_TO_NATIONAL(PETALOUND),
    ...
    HOENN_TO_NATIONAL(FLOETTE_ETERNAL),
