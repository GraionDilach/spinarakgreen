...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    ...
    [TYPE_ROCK]     = {______, X(0.5), X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, ______, X(2.0), X(2.0), ______, ______},
    ...
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.5), ______, X(2.0), X(2.0), X(2.0), X(2.0), ______, X(0.5), X(2.0), X(2.0), X(0.0)},
...
static u32 GetFlingPowerFromItemId(u32 itemId)
{
    if (itemId >= ITEM_TM01 && itemId <= ITEM_HM11)
    {
