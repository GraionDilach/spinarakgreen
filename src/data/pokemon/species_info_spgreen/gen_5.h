...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        ICON(Victini, 0),
        LEARNSETS(Victini),
        .eggMoveLearnset = sVictiniEggMoveLearnset,
    },
...
#define AUDINO_MISC_INFO                                    \
    ...
    [SPECIES_THROH] =
    {
        ...
        ICON(Throh, 0),
        LEARNSETS(Throh),
        .eggMoveLearnset = sThrohEggMoveLearnset,
    },
    ...
    [SPECIES_SAWK] =
    {
        ...
        ICON(Sawk, 0),
        LEARNSETS(Sawk),
        .eggMoveLearnset = sSawkEggMoveLearnset,
    },
#endif //P_FAMILY_SAWK
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        .growthRate = GROWTH_350,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_POISON_POINT, ABILITY_QUICK_FEET, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
...
#define ZOROARK_MISC_INFO                                   \
    ...
    [SPECIES_ZORUA_HISUIAN] =
    {
        ...
        .eggMoveLearnset = sZoruaHisuianEggMoveLearnset,
        .isHisuianForm = TRUE,
...
#define SAWSBUCK_MISC_INFO                                                              \
    ...
    [SPECIES_FOONGUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 39, SPECIES_AMOONGUSS},
                                {EVO_LEVEL_NIGHT, 39, SPECIES_BRUTE_BONNET}),
    },
    ...
    [SPECIES_KLINK] =
    {
        ...
        ICON(Klink, 0),
        LEARNSETS(Klink),
        .eggMoveLearnset = sKlinkEggMoveLearnset,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        ICON(Cryogonal, 0),
        LEARNSETS(Cryogonal),
        .eggMoveLearnset = sCryogonalEggMoveLearnset,
    },
...
#define STUNFISK_MISC_INFO                                          \
    ...
    [SPECIES_BISHARP] =
    {
        ...
        LEARNSETS(Bisharp),
        .eggMoveLearnset = sPawniardEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_FRIENDSHIP, 0, SPECIES_KINGAMBIT}),
    },
...
#define BRAVIARY_MISC_INFO                                      \
    ...
    [SPECIES_ZWEILOUS] =
    {
        ...
        LEARNSETS(Zweilous),
        .eggMoveLearnset = sDeinoEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 64, SPECIES_HYDREIGON},
                                {EVO_LEVEL_NIGHT, 64, SPECIES_IRON_JUGULIS}),
    },
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .growthRate = GROWTH_650,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_PROTOSYNTHESIS },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Volcamoth"),
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .growthRate = GROWTH_650,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_QUARK_DRIVE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Sharpewing"),
        .cryId = CRY_IRON_MOTH,
    ...
    [SPECIES_COBALION] =
    {
        ...
        ICON(Cobalion, 0),
        LEARNSETS(Cobalion),
        .eggMoveLearnset = sCobalionEggMoveLearnset,
    },
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        ICON(Terrakion, 2),
        LEARNSETS(Terrakion),
        .eggMoveLearnset = sTerrakionEggMoveLearnset,
    },
    ...
    [SPECIES_VIRIZION] =
    {
        ...
        ICON(Virizion, 1),
        LEARNSETS(Virizion),
        .eggMoveLearnset = sVirizionEggMoveLearnset,
    },
...
#define TORNADUS_MISC_INFO                                                              \
        ...
        .weight = 630,                                                                  \
        LEARNSETS(Tornadus),                                                            \
        .eggMoveLearnset = sTornadusEggMoveLearnset,                                    \
...
#define THUNDURUS_MISC_INFO                                                             \
        ...
        .weight = 610,                                                                  \
        LEARNSETS(Thundurus),                                                           \
        .eggMoveLearnset = sThundurusEggMoveLearnset,                                   \
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        ICON(Reshiram, 0),
        LEARNSETS(Reshiram),
        .eggMoveLearnset = sReshiramEggMoveLearnset,
    },
    ...
    [SPECIES_ZEKROM] =
    {
        ...
        ICON(Zekrom, 2),
        LEARNSETS(Zekrom),
        .eggMoveLearnset = sZekromEggMoveLearnset,
    },
...
#define LANDORUS_MISC_INFO                                                              \
        ...
        .weight = 680,                                                                  \
        LEARNSETS(Landorus),                                                            \
        .eggMoveLearnset = sLandorusEggMoveLearnset,                                    \
...
#define KYUREM_MISC_INFO                                                                \
        ...
        .eggMoveLearnset = sKyuremEggMoveLearnset,                                      \
        .isLegendary = TRUE
...
#define KELDEO_MISC_INFO                                                                \
        ...
        .trainerOffset = 0,                                                             \
        LEARNSETS(Keldeo),                                                              \
        .eggMoveLearnset = sKeldeoEggMoveLearnset,                                      \
...
#define MELOETTA_MISC_INFO                                                              \
        ...
        .trainerOffset = 0,                                                             \
        LEARNSETS(Meloetta),                                                            \
        .eggMoveLearnset = sMeloettaEggMoveLearnset,                                    \
...
#define GENESECT_SPECIES_INFO(form)                                                     \
    {                                                                                   \
        ...
        ICON(Genesect, 2),                                                              \
        LEARNSETS(Genesect),                                                            \
        .eggMoveLearnset = sGenesectEggMoveLearnset,                                    \
