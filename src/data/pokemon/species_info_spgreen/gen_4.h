...
#define ROTOM_APPLIANCE_INFO(form)                                  \
    ...
    [SPECIES_UXIE] =
    {
        ...
        ICON(Uxie, 0),
        LEARNSETS(Uxie),
        .eggMoveLearnset = sUxieEggMoveLearnset,
    },
#endif //P_FAMILY_UXIE
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        ICON(Mesprit, 0),
        LEARNSETS(Mesprit),
        .eggMoveLearnset = sMespritEggMoveLearnset,
    },
    ...
    [SPECIES_AZELF] =
    {
        ...
        ICON(Azelf, 0),
        LEARNSETS(Azelf),
        .eggMoveLearnset = sAzelfEggMoveLearnset,
    },
...
#define DIALGA_MISC_INFO                                                                \
        ...
        LEARNSETS(Dialga),                                                              \
        .eggMoveLearnset = sDialgaEggMoveLearnset,                                      \
...
#define PALKIA_MISC_INFO                                                                \
        ...
        LEARNSETS(Palkia),                                                              \
        .eggMoveLearnset = sPalkiaEggMoveLearnset,                                      \
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        ICON(Heatran, 0),
        LEARNSETS(Heatran),
        // .eggMoveLearnset = sHeatranEggMoveLearnset,
    },
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        ICON(Regigigas, 0),
        LEARNSETS(Regigigas),
        // .eggMoveLearnset = sRegigigasEggMoveLearnset,
    },
...
#define GIRATINA_MISC_INFO                                                              \
        ...
        LEARNSETS(Giratina),                                                            \
        .eggMoveLearnset = sGiratinaEggMoveLearnset,                                    \
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        ICON(Cresselia, 0),
        LEARNSETS(Cresselia),
        .eggMoveLearnset = sCresseliaEggMoveLearnset,
    },
    ...
    [SPECIES_PHIONE] =
    {
        ...
        ICON(Phione, 0),
        LEARNSETS(Phione),
        .eggMoveLearnset = sPhioneEggMoveLearnset,
    },
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        ICON(Darkrai, 0),
        LEARNSETS(Darkrai),
        .eggMoveLearnset = sDarkraiEggMoveLearnset,
    },
...
#define SHAYMIN_MISC_INFO                                                               \
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .eggMoveLearnset = sShayminLandEggMoveLearnset,
    },
...
#define ARCEUS_SPECIES_INFO(type, typeName)                                             \
    {                                                                                   \
        ...
        ICON(Arceus, 1),                                                                \
        LEARNSETS(Arceus),                                                              \
        .eggMoveLearnset = sArceusEggMoveLearnset,                                      \
