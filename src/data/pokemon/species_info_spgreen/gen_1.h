...
#define VENUSAUR_MISC_INFO                                                  \
    ...
    [SPECIES_VENUSAUR_GIGANTAMAX] =
    {
        ...
        .trainerScale = 388,
        .trainerOffset = 6,
        FRONT_PIC(VenusaurGmax, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_VenusaurGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(VenusaurGmax, 64, 64),
        .backPicYOffset = 11,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(VenusaurGmax),
        ICON(VenusaurGmax, 0),
        LEARNSETS(VenusaurGigantamax),
    },
...
#define CHARIZARD_MISC_INFO                                             \
    ...
    [SPECIES_CHARIZARD_GIGANTAMAX] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 3,
        FRONT_PIC(CharizardGmax, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_CharizardGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(CharizardGmax, 64, 64),
        .backPicYOffset = 1,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(CharizardGmax),
        ICON(CharizardGmax, 0),
        LEARNSETS(CharizardGigantamax),
    },
...
#define BLASTOISE_MISC_INFO                                             \
    ...
    [SPECIES_BLASTOISE_GIGANTAMAX] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        FRONT_PIC(BlastoiseGmax, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_BlastoiseGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(BlastoiseGmax, 64, 64),
        .backPicYOffset = 5,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(BlastoiseGmax),
        ICON(BlastoiseGmax, 0),
        LEARNSETS(BlastoiseGigantamax),
    },
#endif //P_GIGANTAMAX_FORMS
...
#define BUTTERFREE_MISC_INFO                                                        \
    ...
    [SPECIES_BUTTERFREE_GIGANTAMAX] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(ButterfreeGmax, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_ButterfreeGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 7,
        BACK_PIC(ButterfreeGmax, 64, 64),
        .backPicYOffset = 3,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(ButterfreeGmax),
        ICON(ButterfreeGmax, 0),
        LEARNSETS(ButterfreeGigantamax),
    },
#endif //P_GIGANTAMAX_FORMS
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_RATICATE_ALOLAN] =
    {
        ...
        .backPicYOffset = 8,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(RaticateAlola),
        ICON(RaticateAlola, 2),
...
#define PIKACHU_CAP_MISC_INFO                                       \
    ...
    [SPECIES_PIKACHU_GIGANTAMAX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lightning strike."),
        FRONT_PIC(PikachuGmax, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_PikachuGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(PikachuGmax, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(PikachuGmax),
        ICON(PikachuGmax, 2),
    },
#endif //P_GIGANTAMAX_FORMS
...
#define SANDSLASH_MISC_INFO                                 \
    ...
    [SPECIES_SANDSHREW_ALOLAN] =
    {
        ...
        .backPicYOffset = 13,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(SandshrewAlola),
        ICON(SandshrewAlola, 0),
    ...
    [SPECIES_SANDSLASH_ALOLAN] =
    {
        ...
        .backPicYOffset = 6,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(SandslashAlola),
        ICON(SandslashAlola, 0),
...
#define NINETALES_MISC_INFO                                 \
    ...
    [SPECIES_NINETALES_ALOLAN] =
    {
        ...
        .backPicYOffset = 5,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(NinetalesAlola),
        ICON(NinetalesAlola, 2),
...
#define DUGTRIO_MISC_INFO                   \
    ...
    [SPECIES_DIGLETT_ALOLAN] =
    {
        ...
        FRONT_PIC(DiglettAlola, 32, 40),
        .frontPicYOffset = 19,
        .frontAnimFrames = sAnims_DiglettAlola,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(DiglettAlola, 40, 48),
        .backPicYOffset = 14,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(DiglettAlola),
        ICON(DiglettAlola, 2),
    ...
    [SPECIES_DUGTRIO_ALOLAN] =
    {
        ...
        FRONT_PIC(DugtrioAlola, 48, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_DugtrioAlola,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(DugtrioAlola, 64, 32),
        .backPicYOffset = 17,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(DugtrioAlola),
        ICON(DugtrioAlola, 2),
...
#define PERSIAN_MISC_INFO                                   \
    ...
    [SPECIES_MEOWTH_GALARIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MeowthGalar, 48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_MeowthGalar,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(MeowthGalar, 64, 56),
        .backPicYOffset = 8,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(MeowthGalar),
        ICON(MeowthGalar, 0),
    ...
    [SPECIES_MEOWTH_GIGANTAMAX] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MeowthGmax, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_MeowthGmax,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(MeowthGmax, 64, 64),
        .backPicYOffset = 5,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(MeowthGmax),
        ICON(MeowthGmax, 1),
...
#define FARFETCHD_MISC_INFO                                 \
    ...
    [SPECIES_SIRFETCHD] =
    {
        ...
        .weight = 1170,
        .description = COMPOUND_STRING(
            "Only Lorfetch'd that have survived many\n"
            "battles can attain this evolution. When\n"
            "this Pokémon's leek withers, it will\n"
            "retire from combat."),
        .pokemonScale = 366,
...
#define KINGLER_MISC_INFO                                                               \
    ...
    [SPECIES_KINGLER_GIGANTAMAX] =
    {
        ...
        .expYield = 306,
        .growthRate = GROWTH_650,
        .speciesName = _("Emperkrab"),
        .natDexNum = NATIONAL_DEX_KINGLER_GIGANTAMAX,
        .height = 190,
        .weight = 800,
        .description = COMPOUND_STRING(
...
#define MAROWAK_MISC_INFO                                       \
    ...
    [SPECIES_LICKILICKY] =
    {
        ...
        .eggMoveLearnset = sLickitungEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_LICKITOLD}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_LICKITOLD] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_OBLIVIOUS, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Lickitold"),
        .cryId = CRY_LICKILICKY,
        .natDexNum = NATIONAL_DEX_LICKITOLD,
        .categoryName = _("Licking"),
        .height = 17,
        .weight = 1400,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 35, SPECIES_WEEZING},
                                {EVO_LEVEL_DAY, 35, SPECIES_WEEZING_GALARIAN}),
    },
...
#define WEEZING_MISC_INFO                                           \
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_FRIENDSHIP, 0, SPECIES_BLISSEY},
                                {EVO_ITEM_DAY, ITEM_OVAL_STONE, SPECIES_HEARTEY}),
    },
    ...
    [SPECIES_HEARTEY] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SERENE_GRACE, ABILITY_HEALER },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Heartey"),
        .cryId = CRY_BLISSEY,
        .natDexNum = NATIONAL_DEX_HEARTEY,
        .categoryName = _("Happiness"),
        .height = 15,
        .weight = 468,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TANGELICA] =
    {
        ...
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Tangelica"),
        .cryId = CRY_TANGELA,
        .natDexNum = NATIONAL_DEX_TANGELICA,
        .categoryName = _("Vine"),
        .height = 10,
        .weight = 350,
        .description = COMPOUND_STRING(
        ...
        ICON(Tangela, 0),
        LEARNSETS(Tangelica),
        .eggMoveLearnset = sTangelicaEggMoveLearnset,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH},
                                {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_TANGEL}),
    },
...
#define KANGASKHAN_MISC_INFO                                    \
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        PALETTES(Kangaskhan),
        ICON(Kangaskhan, 2),
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_KANGASKHAN_MEGA}),
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                {EVO_LEVEL, 20, SPECIES_MR_MIME_GALARIAN}),
    },
#endif //P_GEN_4_CROSS_EVOS
...
#define MR_MIME_MISC_INFO                                           \
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_SCIZOR},
                                {EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR_MEGA},
                                {EVO_ITEM, ITEM_BLACK_AUGURITE, SPECIES_KLEAVOR},
                                {EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR_MEGA}),
    },
...
#define PINSIR_MISC_INFO                                \
    ...
    [SPECIES_PINSIR] =
    {
        ...
        PALETTES(Pinsir),
        ICON(Pinsir, 2),
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_PINSIR_MEGA},
                                {EVO_ITEM, ITEM_METAL_COAT, SPECIES_PINPLUX}),
        LEARNSETS(Pinsir),
    },
    ...
    [SPECIES_PINPLUX] =
    {
        ...
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_MOLD_BREAKER, ABILITY_MOXIE },
        .cryId = CRY_PINSIR_MEGA,
        .speciesName = _("Pinplux"),
        .natDexNum = NATIONAL_DEX_PINPLUX,
        .height = 17,
        .weight = 590,
        .description = COMPOUND_STRING(
            "The influence of Mega Evolution leaves it\n"
...
#define PALDEAN_TAUROS_BASE_STATS                       \
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 25, SPECIES_GYARADOS},
                                {EVO_LEVEL_NIGHT, 25, SPECIES_GYARADOS_MEGA}),
    },
...
#define LAPRAS_MISC_INFO                                                                \
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        PALETTES(Lapras),
        ICON(Lapras, 2),
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_LAPRAS_GIGANTAMAX}),
        LEARNSETS(Lapras),
    },
    ...
    [SPECIES_LAPRAS_GIGANTAMAX] =
    {
        ...
        .expYield = 187,
        .growthRate = GROWTH_650,
        .speciesName = _("Laplarge"),
        .natDexNum = NATIONAL_DEX_LAPRAS_GIGANTAMAX,
        .height = 240,
        .weight = 0,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DITTO] =
    {
        ...
        ICON(Ditto, 2),
        LEARNSETS(Ditto),
        //.eggMoveLearnset = sDittoEggMoveLearnset,
    },
...
#define EEVEE_MISC_INFO                                                                 \
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_EEVEE_GIGANTAMAX}),
    },
    ...
    [SPECIES_EEVEE_GIGANTAMAX] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Commeon"),
        .cryId = CRY_EEVEE,
        .natDexNum = NATIONAL_DEX_EEVEE_GIGANTAMAX,
        .categoryName = _("Intertwine"),
        .height = 10,
        .weight = 235,
        .description = COMPOUND_STRING(
            "Having gotten even friendlier and\n"
            "more innocent, Commeon tries to play\n"
...
#define AERODACTYL_MISC_INFO                                \
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        PALETTES(Aerodactyl),
        ICON(Aerodactyl, 2),
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_AERODACTYL_MEGA}),
...
#define SNORLAX_MISC_INFO                                                       \
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        PALETTES(Snorlax),
        ICON(Snorlax, 3),
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_SNORLAX_GIGANTAMAX}),
        LEARNSETS(Snorlax),
    },
    ...
    [SPECIES_SNORLAX_GIGANTAMAX] =
    {
        ...
        .expYield = 333,
        .growthRate = GROWTH_650,
        .speciesName = _("Horklax"),
        .natDexNum = NATIONAL_DEX_SNORLAX_GIGANTAMAX,
        .height = 35,
        .weight = 9200,
        .description = COMPOUND_STRING(
            "Gigantamax energy has affected\n"
            "stray seeds and even pebbles that\n"
            "got stuck to Horklax, making them grow\n"
            "to a huge size."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 423,
...
#endif //P_MEWTWO_MEGA_EVOLUTIONS
