...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_AROMA_VEIL, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        ICON(Carbink, 2),
        LEARNSETS(Carbink),
        .eggMoveLearnset = sCarbinkEggMoveLearnset,
...
#define XERNEAS_MISC_INFO(Form)                                                         \
    {                                                                                   \
        ...
        ICON(Xerneas##Form, 0),                                                         \
        LEARNSETS(Xerneas),                                                             \
        .eggMoveLearnset = sXerneasEggMoveLearnset,                                     \
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        ICON(Yveltal, 0),
        LEARNSETS(Yveltal),
        .eggMoveLearnset = sYveltalEggMoveLearnset,
    },
...
#define ZYGARDE_MISC_INFO(ability)                                                      \
        ...
        LEARNSETS(Zygarde),                                                             \
        .eggMoveLearnset = sZygardeEggMoveLearnset,                                     \
...
#define HOOPA_MISC_INFO                                                                 \
        ...
        .eggMoveLearnset = sHoopaConfinedEggMoveLearnset,                               \
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        ICON(Volcanion, 0),
        LEARNSETS(Volcanion),
        .eggMoveLearnset = sVolcanionEggMoveLearnset,
    },
