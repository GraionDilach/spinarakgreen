...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    #include "species_info_spgreen/gen_1.h"
    #include "species_info_spgreen/gen_2.h"
    #include "species_info_spgreen/gen_3.h"
    #include "species_info_spgreen/gen_4.h"
    #include "species_info_spgreen/gen_5.h"
    #include "species_info_spgreen/gen_6.h"
