...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .effect = EFFECT_MULTI_HIT,
        .power = 18,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_FIGHTING : TYPE_NORMAL,
        .accuracy = 85,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_VISE_GRIP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 55,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_BUG : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 30,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_GUILLOTINE] =
    {
        ...
        .effect = EFFECT_OHKO,
        .power = 1,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_STEEL : TYPE_NORMAL,
        .accuracy = 30,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .power = 80,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_FLYING : TYPE_NORMAL,
        .accuracy = 100,
        .criticalHitStage = 1,
        .pp = 10,
    ...
    [MOVE_SWORDS_DANCE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 20 : 30,
    ...
    [MOVE_JUMP_KICK] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA >= GEN_5 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 10 : 25,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_HORN_ATTACK] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 65,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_ROCK :TYPE_NORMAL,
        .accuracy = 100,
        .pp = 25,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SING] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_FAIRY : TYPE_NORMAL,
        .accuracy = 55,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SUPERSONIC] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_DARK : TYPE_NORMAL,
        .accuracy = 55,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_FLAMETHROWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may inflict a burn."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 95,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HYDRO_PUMP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to strike the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 110 : 120,
        .type = TYPE_WATER,
        .accuracy = 80,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 33 : 10,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_SUBMISSION] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 80,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 20 : 25,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_ABSORB] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 40 : 20,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_MEGA_DRAIN] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 75 : 40,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 140 : 120,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_THUNDER_WAVE] =
    {
        ...
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_DIG] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : B_UPDATED_MOVE_DATA >= GEN_4 ? 80 : 60,
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HYPNOSIS] =
    {
        ...
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 70 : 60,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_MINIMIZE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 10 : 20,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_METRONOME] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_MYSTERY : TYPE_NORMAL,
        .accuracy = 0,
        .pp = 10,
        .target = MOVE_TARGET_DEPENDS,
        .priority = 0,
    ...
    [MOVE_SLUDGE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON,
            .chance = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 40 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_SOFT_BOILED] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 5 : 10,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_HIGH_JUMP_KICK] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 90,
        .pp = B_UPDATED_MOVE_DATA >= GEN_5 && B_UPDATED_MOVE_DATA != GEN_SPGRN? 10 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_BARRAGE] =
    {
        ...
        .effect = EFFECT_MULTI_HIT,
        .power = 15,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_GRASS : TYPE_NORMAL,
        .accuracy = 85,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SKY_ATTACK] =
    {
        ...
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 200 : 140,
        .type = TYPE_FLYING,
        .accuracy = 90,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ACID_ARMOR] =
    {
        ...
        .type = TYPE_POISON,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6  && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 20 : 40,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_EXPLOSION] =
    {
        ...
        .effect = EFFECT_EXPLOSION,
        .power = 250,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_FIRE : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_FOES_AND_ALLY,
        .priority = 0,
    ...
    [MOVE_MIND_READER] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_PSYCHIC : TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_4 ? 0 : 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_GIGA_DRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 110 : B_UPDATED_MOVE_DATA >= GEN_5 ? 75 : 60,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_SWAGGER] =
    {
        ...
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 85 : 90,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_PAIN_SPLIT] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_GHOST : TYPE_NORMAL,
        .accuracy = 0,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_HIDDEN_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "vary with the user."),
        #endif
        .power = B_HIDDEN_POWER_DMG == GEN_SPGRN ? 70 : B_HIDDEN_POWER_DMG >= GEN_6 ? 60 : 1,
    ...
    [MOVE_HEAT_WAVE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 95 : 100,
        .type = TYPE_FIRE,
        .accuracy = 90,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_METEOR_MASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May raise Attack."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_OVERHEAT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 130 : 140,
        .type = TYPE_FIRE,
        .accuracy = 90,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FEINT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 30 : 50,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 15 : 30,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_BOOST_CRITS },
    ...
    [MOVE_SUCKER_PUNCH] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_7 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 70 : 80,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AURA_SPHERE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that cannot be evaded."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 80 : 90,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AIR_SLASH] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 15 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .slicingMove = TRUE,
    ...
    [MOVE_DRAGON_PULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "damage the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 85 : 90,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MAGMA_STORM] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 100 : 120,
        .type = TYPE_FIRE,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 50 : 80,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_DRAGON_ASCENT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 120,
        .type = B_UPDATED_MOVE_TYPES == GEN_SPGRN ? TYPE_DRAGON : TYPE_FLYING,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        #endif
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 60 : 90,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_8 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 20 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 80 : 90,
        .type = TYPE_PSYCHIC,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_8 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 95 : 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_9 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 55 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_TERRAIN_PULSE] =
    {
        ...
        .power = 50,
        .type = B_UPDATED_MOVE_FLAGS == GEN_SPGRN ? TYPE_MYSTERY : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_WICKED_BLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 75 : 80,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 120 : 130,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_BARB_BARRAGE] =
    {
        ...
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 && B_UPDATED_MOVE_DATA != GEN_SPGRN ? 10 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .status = STATUS1_PSN_ANY },
