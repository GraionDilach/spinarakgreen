...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 15 : 20,
        .type = TYPE_NORMAL,
        .accuracy = 85,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MEGA_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "incredible power."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 80 : 90,
        #if B_UPDATED_MOVE_TYPES == GEN_SPGRN
            .type = TYPE_FIGHTING,
        #else
            .type = TYPE_NORMAL,
        #endif
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 85 :95,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SWORDS_DANCE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 20 : 30,
    ...
    [MOVE_SLICE] = //SmithPlays Legacy Cut
    {
        .name = COMPOUND_STRING("Slice"),
        .description = COMPOUND_STRING(
            "Cuts the foe with sharp\n"
            "scythes, claws, etc."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BIND] =
    {
        ...
        .power = 15,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 75, // Emerald Legacy goes for 100
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_MEGA_KICK] =
    {
        ...
        .power = 120,
            ...
            .type = TYPE_NORMAL,
        #endif
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 75 : 85,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_ROLLING_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "a rapid spin."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 70 : 60,
        .type = TYPE_FIGHTING,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : 85,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FURY_ATTACK] =
    {
        ...
        .effect = EFFECT_MULTI_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 15 : 18,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 85 : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_WRAP] =
    {
        ...
        .power = 15,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 85,  // Emerald Legacy goes for 100
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_TAKE_DOWN] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 95,
        .type = TYPE_NORMAL,
        .accuracy = 85,
        .recoil = 25,
        .pp = 20,
    ...
    [MOVE_PIN_MISSILE] =
    {
        ...
        .type = TYPE_BUG,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? (B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 85) : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SONIC_BOOM] =
    {
        ...
        .power = 1,
            ...
            .type = TYPE_NORMAL,
        #endif
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_FLAMETHROWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may inflict a burn."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HYDRO_PUMP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to strike the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 120,
        .type = TYPE_WATER,
        .accuracy = 80,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SURF] =
    {
        ...
        .accuracy = 100,
        .pp = 15,
        .target = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_4 ? MOVE_TARGET_FOES_AND_ALLY : MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_ABSORB] =
    {
        ...
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_4 ? 25 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ignoresKingsRock = (B_UPDATED_MOVE_FLAGS == GEN_3 || B_UPDATED_MOVE_FLAGS == GEN_4),
    ...
    [MOVE_MEGA_DRAIN] =
    {
        ...
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_4 ? 15 : 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_THUNDER_WAVE] =
    {
        ...
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_7 ? 90 : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_ROCK_THROW] =
    {
        ...
        .power = 50,
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 95 : 90,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_MINIMIZE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 10 : 20,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_LICK] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 40 : B_UPDATED_MOVE_DATA >= GEN_6 ? 30 : 20,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 30,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SPIKE_CANNON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strike 2 to 5 times."),
        .effect = EFFECT_MULTI_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 30 : 20,
        .type = B_UPDATED_MOVE_DATA == GEN_SPGRN ? TYPE_STEEL : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SOFT_BOILED] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_9 ? 5 : 10,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_CRABHAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "high critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 110 : B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 90,
        .type = TYPE_WATER,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 85,
        .criticalHitStage = 1,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_FURY_SWIPES] =
    {
        ...
        .power = 18,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 80 : 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_ROCK_SLIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 80 : 75,
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 95 : 90,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_CURSE] =
    {
        ...
        .effect = EFFECT_CURSE,
        .power = 0,
        .type = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_TYPES >= GEN_5 ? TYPE_GHOST : TYPE_MYSTERY,
        .accuracy = 0,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_ZAP_CANNON] =
    {
        ...
        .type = TYPE_ELECTRIC,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 70 : 50,
    ...
    [MOVE_GIGA_DRAIN] =
    {
        ...
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_4 ? 10 : 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ignoresKingsRock = (B_UPDATED_MOVE_FLAGS == GEN_3 || B_UPDATED_MOVE_FLAGS == GEN_4),
    ...
    [MOVE_SWAGGER] =
    {
        ...
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_7 ? 85 : 90,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_IRON_TAIL] =
    {
        ...
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 90 : 75,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_METAL_CLAW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 60 : 50,
        .type = TYPE_STEEL,
        .accuracy = 95,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_CROSS_CHOP] =
    {
        ...
        .power = 100,
        .type = TYPE_FIGHTING,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 90 : 80,
        .criticalHitStage = 1,
        .pp = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 10 : 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_BEAT_UP] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 20 : B_UPDATED_MOVE_DATA >= GEN_5 ? 1 : 10,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HEAT_WAVE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 100,
        .type = TYPE_FIRE,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : 90,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_NEEDLE_ARM] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FLINCH,
            .chance = 30,
        // also 30% defense lowering from Emerald Legacy?
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_HYPER_VOICE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 90 : 100,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_CRUSH_CLAW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 75 : 80,
        .type = TYPE_NORMAL,
        .accuracy = 95,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_METEOR_MASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May raise Attack."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_ASTONISH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 50 : 30,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AIR_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 65 : B_UPDATED_MOVE_DATA >= GEN_6 ? 60 : 55,
        .type = TYPE_FLYING,
        .accuracy = 95,
        .criticalHitStage = 1,
        .pp = 25,
    ...
    [MOVE_GRASS_WHISTLE] =
    {
        ...
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 85 : 55,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_SIGNAL_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may confuse the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN ? 75 : 85,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SAND_TOMB] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 35 : 15,
        .type = TYPE_GROUND,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 70,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_MUDDY_WATER] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_WATER,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ?  95 : 85,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_BOUNCE] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 100 : 85,
        .pp = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 15 : 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_POISON_TAIL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_SPGRN ? 80 : 50,
        .type = TYPE_POISON,
        .accuracy = 100,
        .criticalHitStage = 1,
        .pp = 25,
    ...
    [MOVE_LEAF_BLADE] =
    {
        ...
        // 50% increase crit ratio from Emerald Legacy?
    },
    ...
    [MOVE_FEINT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_5 ? 30 : 50,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 15 : 30,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_BOOST_CRITS },
    ...
    [MOVE_SUCKER_PUNCH] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_7 ? 70 : 80,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AURA_SPHERE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that cannot be evaded."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 90,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AIR_SLASH] =
    {
        ...
        .type = TYPE_FLYING,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 15 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .slicingMove = TRUE,
    ...
    [MOVE_DRAGON_PULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "damage the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 85 : 90,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MAGMA_STORM] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 120,
        .type = TYPE_FIRE,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_7 ? 50 : 80,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_9 ? 55 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_WICKED_BLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_9 ? 75 : 80,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_9 ? 120 : 130,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_BARB_BARRAGE] =
    {
        ...
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA != GEN_SPGRN && B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = STATUS1_PSN_ANY,
    ...
    [MOVE_PSYRIPPLE] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_Psyripple,
    },
    ...
    [MOVE_COMET_CRASH] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_CometCrash,
    },
    ...
    [MOVE_TERA_BALL] =
    {
        .name = COMPOUND_STRING("Tera Ball"),
        .description = COMPOUND_STRING(
            "Hits with its Tera-type."),
        .effect = EFFECT_TERA_BLAST,
        .power = 80,
