...
const u16 gMetatiles_SpG_General[] = INCBIN_U16("data/tilesets/primary/spg_general/metatiles.bin");
const u16 gMetatileAttributes_SpG_General[] = INCBIN_U16("data/tilesets/primary/spg_general/metatile_attributes.bin");
