...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA"), 5, BALL_NET },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 10, BALL_HEAL },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15, BALL_MOON },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 8, BALL_FAST },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 8, BALL_LEVEL },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4, BALL_SAFARI },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 4, BALL_SAFARI},
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 15, BALL_SPORT },
    ...
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20, BALL_PREMIER },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50, BALL_CHERISH },
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = { _("SALON MAIDEN"), 5, BALL_CHERISH },
    [TRAINER_CLASS_DOME_ACE] = { _("DOME ACE"), 5, BALL_CHERISH },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("PALACE MAVEN"), 5, BALL_CHERISH },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("ARENA TYCOON"), 5, BALL_CHERISH },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("FACTORY HEAD"), 5, BALL_CHERISH },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("PIKE QUEEN"), 5, BALL_CHERISH },
    [TRAINER_CLASS_PYRAMID_KING] = { _("PYRAMID KING"), 5, BALL_CHERISH },
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 firstTrainer, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            {
                s32 ev = ((level * 5 / 2) < 255) ? (level * 5 / 2) : 255;
