...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TRAINER_CLASS_HIKER, "HIKER", 10, ITEM_HEAVY_BALL),
    TRAINER_CLASS(TRAINER_CLASS_TEAM_AQUA, "TEAM AQUA", 5, ITEM_NET_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_BIRD_KEEPER, "BIRD KEEPER", 8, ITEM_QUICK_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_TEAM_MAGMA, "TEAM MAGMA", 5, ITEM_NEST_BALL),
    TRAINER_CLASS(TRAINER_CLASS_EXPERT, "EXPERT", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(TRAINER_CLASS_AQUA_ADMIN, "AQUA ADMIN", 10, ITEM_NET_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_HEX_MANIAC, "HEX MANIAC", 6, ITEM_DUSK_BALL),
    TRAINER_CLASS(TRAINER_CLASS_AROMA_LADY, "AROMA LADY", 10, ITEM_FRIEND_BALL, 150),
    TRAINER_CLASS(TRAINER_CLASS_RUIN_MANIAC, "RUIN MANIAC", 15, ITEM_DUSK_BALL),
    TRAINER_CLASS(TRAINER_CLASS_INTERVIEWER, "INTERVIEWER", 12, ITEM_REPEAT_BALL),
    TRAINER_CLASS(TRAINER_CLASS_TUBER_F, "TUBER", 1, ITEM_DIVE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_TUBER_M, "TUBER", 1, ITEM_DIVE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_LADY, "LADY", 50, ITEM_LUXURY_BALL),
    TRAINER_CLASS(TRAINER_CLASS_BEAUTY, "BEAUTY", 20, ITEM_LOVE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_RICH_BOY, "RICH BOY", 50, ITEM_LUXURY_BALL),
    TRAINER_CLASS(TRAINER_CLASS_POKEMANIAC, "POKéMANIAC", 15, ITEM_MOON_BALL),
    TRAINER_CLASS(TRAINER_CLASS_GUITARIST, "GUITARIST", 8, ITEM_FAST_BALL),
    TRAINER_CLASS(TRAINER_CLASS_KINDLER, "KINDLER", 8),
    TRAINER_CLASS(TRAINER_CLASS_CAMPER, "CAMPER", 4, ITEM_NEST_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PICNICKER, "PICNICKER", 4, ITEM_SAFARI_BALL),
    TRAINER_CLASS(TRAINER_CLASS_BUG_MANIAC, "BUG MANIAC", 15, ITEM_NET_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PSYCHIC, "PSYCHIC", 6, ITEM_DREAM_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_LEADER, "LEADER", 25, ITEM_ULTRA_BALL),
    TRAINER_CLASS(TRAINER_CLASS_SCHOOL_KID, "SCHOOL KID"),
    TRAINER_CLASS(TRAINER_CLASS_SR_AND_JR, "SR. AND JR.", 4),
    TRAINER_CLASS(TRAINER_CLASS_WINSTRATE, "WINSTRATE", 10, ITEM_GREAT_BALL),
    TRAINER_CLASS(TRAINER_CLASS_POKEFAN, "POKéFAN", 20),
    TRAINER_CLASS(TRAINER_CLASS_YOUNGSTER, "YOUNGSTER", 4),
    TRAINER_CLASS(TRAINER_CLASS_CHAMPION, "CHAMPION", 50, ITEM_CHERISH_BALL),
    TRAINER_CLASS(TRAINER_CLASS_FISHERMAN, "FISHERMAN", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_BALL : ITEM_LURE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_TRIATHLETE, "TRIATHLETE", 10, ITEM_FAST_BALL),
    TRAINER_CLASS(TRAINER_CLASS_DRAGON_TAMER, "DRAGON TAMER", 12, ITEM_ULTRA_BALL),
    TRAINER_CLASS(TRAINER_CLASS_NINJA_BOY, "NINJA BOY", 3, ITEM_QUICK_BALL),
    TRAINER_CLASS(TRAINER_CLASS_BATTLE_GIRL, "BATTLE GIRL", 6, ITEM_HEAVY_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_SAILOR, "SAILOR", 8, ITEM_DIVE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_COOLTRAINER_2, "COOLTRAINER", 5, ITEM_ULTRA_BALL),
    TRAINER_CLASS(TRAINER_CLASS_MAGMA_ADMIN, "MAGMA ADMIN", 10, ITEM_NEST_BALL),
    TRAINER_CLASS(TRAINER_CLASS_RIVAL, "{PKMN} TRAINER", 15),
    TRAINER_CLASS(TRAINER_CLASS_BUG_CATCHER, "BUG CATCHER", 4, ITEM_NET_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PKMN_RANGER, "{PKMN} RANGER", 12, ITEM_SAFARI_BALL),
    TRAINER_CLASS(TRAINER_CLASS_MAGMA_LEADER, "MAGMA LEADER", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_LASS, "LASS", 4),
    TRAINER_CLASS(TRAINER_CLASS_YOUNG_COUPLE, "YOUNG COUPLE", 8, ITEM_LOVE_BALL),
    TRAINER_CLASS(TRAINER_CLASS_OLD_COUPLE, "OLD COUPLE", 10),
    TRAINER_CLASS(TRAINER_CLASS_SIS_AND_BRO, "SIS AND BRO", 3),
    TRAINER_CLASS(TRAINER_CLASS_SALON_MAIDEN, "SALON MAIDEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_DOME_ACE, "DOME ACE", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PALACE_MAVEN, "PALACE MAVEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_ARENA_TYCOON, "ARENA TYCOON", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_FACTORY_HEAD, "FACTORY HEAD", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PIKE_QUEEN, "PIKE QUEEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(TRAINER_CLASS_PYRAMID_KING, "PYRAMID KING", 5, ITEM_PREMIER_BALL),
    ...
    case EFFECT_HIDDEN_POWER:
        {
            ...
            moveType = ((NUMBER_OF_MON_TYPES - 4) * typeBits) / 63 + 2;
