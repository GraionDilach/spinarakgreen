...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TEAM_AQUA, "TEAM AQUA", 5, ITEM_NET_BALL),
    ...
    TRAINER_CLASS(BIRD_KEEPER, "BIRD KEEPER", 8, ITEM_QUICK_BALL),
    TRAINER_CLASS(COLLECTOR, "COLLECTOR", 15, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "SWIMMER♂", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "TEAM MAGMA", 5, ITEM_NEST_BALL),
    TRAINER_CLASS(EXPERT, "EXPERT", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 10, ITEM_NET_BALL),
    ...
    TRAINER_CLASS(AROMA_LADY, "AROMA LADY", 10, ITEM_FRIEND_BALL, 150),
    TRAINER_CLASS(RUIN_MANIAC, "RUIN MANIAC", 15, ITEM_DUSK_BALL),
    TRAINER_CLASS(INTERVIEWER, "INTERVIEWER", 12, ITEM_REPEAT_BALL),
    ...
    TRAINER_CLASS(POKEMANIAC, "POKéMANIAC", 15, ITEM_MOON_BALL),
    ...
    TRAINER_CLASS(PICNICKER, "PICNICKER", 4, ITEM_SAFARI_BALL),
    ...
    TRAINER_CLASS(MAGMA_ADMIN, "MAGMA ADMIN", 10, ITEM_NEST_BALL),
    ...
    TRAINER_CLASS(SALON_MAIDEN, "SALON MAIDEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(DOME_ACE, "DOME ACE", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(PALACE_MAVEN, "PALACE MAVEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(ARENA_TYCOON, "ARENA TYCOON", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(FACTORY_HEAD, "FACTORY HEAD", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(PIKE_QUEEN, "PIKE QUEEN", 5, ITEM_PREMIER_BALL),
    TRAINER_CLASS(PYRAMID_KING, "PYRAMID KING", 5, ITEM_PREMIER_BALL),
...
void SetTypeBeforeUsingMove(u32 move, u32 battlerAtk)
{
    ...
    else if (gMovesInfo[move].effect == EFFECT_HIDDEN_POWER)
    {
        ...
        // Graion: changed the 4 to 3, to include TYPE_FAIRY
